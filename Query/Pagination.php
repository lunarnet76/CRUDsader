...
namespace CRUDsader\Query {
    ...
    class Pagination extends \CRUDsader\Query {
        ...
        public function getPagesCount() {
            return floor($this->_session->numRows / $this->_options['count'])+1;
        }
        ...
        public function getNextPage() {
            $actual = $this->getPage();
            return array('actual' => false, 'text' => $actual + 1, 'start' => ($actual) * $this->_options['count'],'index'=>$this->_index);
        }

        public function getPreviousPage() {
            $actual = $this->getPage();
            return array('actual' => false, 'text' => $actual - 1, 'start' => ($actual-2) * $this->_options['count'],'index'=>$this->_index);
        }
        ...
        public function getFirstPage() {
            return array('actual' => false, 'text' => '1', 'start' => 0,'index'=>$this->_index);
        }
        ...
        public function getLastPage() {
            $count = $this->getPagesCount();
            return array('actual' => false, 'text' => $count + 1, 'start' => ($count - 1) * $this->_options['count'],'index'=>$this->_index);
        }
    }
