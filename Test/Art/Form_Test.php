...
class Form_Test extends PHPUnit_Framework_TestCase {
    ...
    function test_constructor() {
        ...
        $form3 = $form2->add(new \Art\Form());

        $i1 = $form2->add(new \Art\Form\Component(), 'i1', true);
        $i2 = $form3->add(new \Art\Form\Component(), 'i2', true);
        $i3 = $form3->add(new \Art\Form\Component(), 'i3', true);
        $i4 = $form3->add(new \Art\Form\Component(), 'i4', false);
        $i5 = $form3->add(new \Art\Form\Component(), 'i5', false);
        $form3->remove('i5');
        $_REQUEST = array(
            '0' => array(
                '0' => array(
