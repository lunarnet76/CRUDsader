 ...
 * @since       0.1
 */
namespace CRUDsader\Database {
    /**
     * DB Descriptor adapter
     * @package    CRUDsader\Database
     */
    abstract class Descriptor extends \CRUDsader\MetaClass{
         ...
         * @var array
         */
        protected $_hasDependencies = array('connector');
         ...
         * @static
         * @param string $value
         * @param \CRUDsader\Database\Connector $connector=null $connector
         * @return string
         */
